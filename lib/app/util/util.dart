...
// Print the deviceId
  ...
  static Future<String> createDynamicLink(bool short, String courseID) async {
    ...
    String DynamicLink =
        'http://edugatem.com/course_details?courseID=$courseID';
    const String Link = 'https://https://doctorpsychological.page.link';
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: 'https://doctorpsychological.page.link',
      longDynamicLink: Uri.parse(
        'https://doctorpsychological.page.link?efr=0&ibi=com.doctor.psychological_flutter&apn=com.doctor.psychological_flutter&imv=0&amv=0&link=$DynamicLink&ofl=https://ofl-example.com',
      ),
      link: Uri.parse(DynamicLink),
      androidParameters: const AndroidParameters(
        packageName: 'com.doctor.psychological_flutter',
        minimumVersion: 0,
      ),
      iosParameters: const IOSParameters(
        bundleId: 'com.doctor.psychological_flutter',
        minimumVersion: '0',
      ),
    );
