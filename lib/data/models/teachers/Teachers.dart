...
class Teachers {
  ...
  Teachers.fromJson(dynamic json) {
    ...
    categories2 = json['categories'] != null
        ? new Categories2.fromJson(json['categories'])
        : null;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['price_30'] = price30;
    map['price_45'] = price45;
    ...
    if (this.categories2 != null) {
        //data['categories'] = this.categories2!.toJson();
    }
    ...
    map['consultations_count'] = consultationsCount;
