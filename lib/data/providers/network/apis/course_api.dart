...
class CourseAPI implements APIRequestRepresentable {
  ...
  CourseAPI.checkoutCourse(String coupon, String discountID,String subTotal,String discount,String total)
      : this._(
            coupon: coupon,
  ...
  CourseAPI.search(String searchText, String? organID, String? groupID,String type2)
      : this._(
            searchText: searchText,
            organID: organID,
            groupID: groupID,
            type: ApiType.search,type2: type2);
  ...
  Future addCommentRequest() async {
    ...
    if (commentRequest?.commentImag != null) {
      ...
      multipartFile =http.MultipartFile.fromPath(
        'image',
        imagefile.path,
      );
