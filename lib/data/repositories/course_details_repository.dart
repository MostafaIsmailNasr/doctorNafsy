...
class CourseDetailsRepositoryIml extends CourseDetailsRepository {
  ...
  @override
  Future<BaseResponse> checkoutCourse(String coupon, String discountID,String subTotal,String discount,String total) async{
    var response = await CourseAPI.checkoutCourse(coupon,discountID,subTotal,discount,total).request();
    print(response);
    return BaseResponse.fromJson(response);
  }
