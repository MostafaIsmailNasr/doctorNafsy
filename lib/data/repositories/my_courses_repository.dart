...
class MyCoursesRepositoryIml extends MyCoursesRepository {
  ...
  @override
  Future<SearchResponse> search(String searchText, String? organID,String? groupID,String type2)async {
    var response = await CourseAPI.search(searchText,organID,groupID,type2).request();
    print(response);
