...
import 'package:eduGate_flutter/presentation/controllers/consultingDetailsController/ConsultingDetailsController.dart';
...
import 'package:eduGate_flutter/app/services/local_storage.dart';
import 'package:eduGate_flutter/app/util/dependency.dart';
import 'package:eduGate_flutter/presentation/app.dart';
...
void main() async {
  ...
  await Firebase.initializeApp(
//name: "Eclass",
      // options: FirebaseOptions(apiKey: "AIzaSyCsnkywD5tdUnqYgIc7J7PWe23RxWs5iZs",
      //     authDomain: "mega-d9bce.firebaseapp.com",
      //     projectId: "mega-d9bce",
      //     storageBucket: "mega-d9bce.appspot.com",
      //     messagingSenderId: "562075152753",
      //     appId: "1:562075152753:web:1e5cf3aba8e267785346d0",
      //     measurementId: "G-C82V1HWPRH"),
      );
 // final controller=Get.put(ConsultingDetailsController());

  //PluginUtilities.getCallbackFromHandle(CallbackHandle.fromRawHandle(0));
  ...
  SystemChrome.setPreferredOrientations(
    ...
    runApp(AncestorWidget(
        data: 'Ancestor Data', child: RestartWidget(child: App())));
  });
  //configLoading();
