...
class FinishedItem extends StatelessWidget{
  ...
  FinishedItem({required this.consultant});
  @override
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              const SizedBox(width: 5,),
                              Text(consultant?.date.toString()??"",style: AppTextStyles.titleMo.copyWith(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Row(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  SvgPicture.asset(Assets.imagesMoney2,color: AppColors.primary,),
                                  const SizedBox(width: 5,),
