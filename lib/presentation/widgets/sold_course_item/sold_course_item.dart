                ...
                child: ClipRRect(
                    ...
                    child: Image.network(
                      ...
                      errorBuilder: (context, error, stackTrace) =>
                          Center(child: Image(image: AssetImage('assets/images/doctor_logo_blue.png'),)),
                    )),
              ),
              const SizedBox(
                width: 10,
                        ...
                        children: [
                          ...
                          isSolid?StarRating(
                            ...
                            children: [
                              ...
                              children: [
                             SvgPicture.asset(  isSolid? Assets.imagesClock:Assets.imagesUser),
                             Expanded(
                               child: Text(
                          ...
                          Row(
                            children: [
                              SvgPicture.asset(  isSolid? Assets.imagesClock:Assets.imagesCalendar2),
                              Text(
                                "${course.duration??"-"}"" "+_local.hours,
                                style: AppTextStyles.title2
                                    .copyWith(color: AppColors.gray2, fontSize: 13),
                              )
                            ],
