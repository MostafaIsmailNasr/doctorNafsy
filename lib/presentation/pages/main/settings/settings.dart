...
import 'package:eduGate_flutter/presentation/pages/main/settings/subscription_tab.dart';
...
class SettingsScreen extends GetView<RegisterController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: buildMainToolBar(controller,isMenu: true, _local.settings, () => controller.toggleDrawer()),
      body: Column(
                          ...
                          tabs: [
                            ...
                            /*Tab(
                              ...
                              *//*decoration: BoxDecoration(
                                                borderRadius: BorderRadius.circular(16),
                                                border: Border.all(
                                                    color: AppColors.primary3, width: 1)),*//*
                              child: Align(
                                alignment: Alignment.center,
                                child: Text(
                                  _local.subscription,
