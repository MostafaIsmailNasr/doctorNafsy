        ...
        trailing: type == 1
            ? Container(
                ...
                decoration: BoxDecoration(
                    color: ticket.status=="open"?AppColors.green:(ticket.status=="close"?AppColors.red:AppColors.green),
                    borderRadius: BorderRadius.all(Radius.circular(10))),
                child: Padding(
                    ...
                    child: Text(
                      ticket.status ?? "",
                      style: AppTextStyles.title2
                          .copyWith(fontSize: 10, color:  ticket.status=="open"?Colors.white:Colors.white),
                    )))
            ...
            child: Align(
                ...
                child: Theme(
                  ...
                  /* decoration: BoxDecoration(
                          ...
                          child: Align(
                            alignment: Alignment.center,
                            child: Text(_local.technical_support,
                        ...
                        Tab(
                          ...
                          /* decoration: BoxDecoration(
                           ...
                           color: AppColors.primary, width: 1)),*/
                              child: Align(
                                alignment: Alignment.center,
                                child: Text(_local.contact_the_administration,
                                textAlign: TextAlign.center),
                              ),
                            )),
                      ]),
