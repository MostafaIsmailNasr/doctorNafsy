...
import '../main/consulting/consulting_screeen.dart';
        ...
        child: SingleChildScrollView(
          child:
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        child: ClipRRect(
                          ...
                          child:Obx(() => !controller.isLoading.value? Image.network(
                              ...
                              errorBuilder: (context, error, stackTrace) =>
                                  Center(child:SvgPicture.asset(Assets.imagesUser,color: Colors.grey,width: 100,height: 100,))):const CircularProgressIndicator()),
                        ),
                      ),
                      Positioned(
                          right: 0,
                          ...
                          child: InkWell(
                              ...
                              child:const Image(image: AssetImage('assets/images/drawer_setting.png'),)))
                    ],
                  ),
                ),
                Obx(() =>Text(
                ...
                getMenuItem(Assets.imagesConsulting, _local.consulting, () {
                  controller.toggleDrawer();
