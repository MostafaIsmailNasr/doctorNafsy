import 'package:eduGate_flutter/presentation/pages/home/psychologicalShowAll/psychological_screen.dart';
import 'package:eduGate_flutter/presentation/pages/home/therapistShowAll/therapist_show_all_screen.dart';
import 'package:eduGate_flutter/presentation/widgets/custom_toast/custom_toast.dart';
...
import '../../widgets/available_doctor_Item/AvailableDoctorItem.dart';
...
import '../main/teachers/coach/coach_screen.dart';
import '../main/teachers/psychological/psychological_screen.dart';
import '../main/teachers/teachers.dart';
import '../main/teachers/therapist/therapist_screen.dart';
import '../search/search.dart';
import 'coachShowAll/coach_show_all_screen.dart';
                          ...
                          child: Stack(
                            children: [
                              Container(
                                  ...
                                  child: SvgPicture.asset(Assets.imagesIcNoti,color: Colors.white,)),
                              Obx(() =>
                            ...
                            child: Column(
                              children: [
                                ...
                                getRowHeader(_local.featured_courses, () {
                                  ...
                                  //Get.to(PsychologicalShowAllScreen());
                                  Get.to(PsychologicalShowAllScreen(),binding:
                                  TeachersBinding());
                                }),
                                Obx(
                                      ...
                                      child: ListView.builder(
                                        ...
                                        itemBuilder: (context, position) {
                                          //var item = controller.featuredCourses.value[position] as Course;
                                          return AvailableDoctorItem(
                                              doctors: controller.doctorsList[position],
                                          );
                                        },
                                      )) /* ListView(
                                      shrinkWrap: true,
                                ...
                                //////// Psychiatrists///////
                                getRowHeader(_local.psychiatrists, () {
                                  Get.to(TherapistShowAllScreen());
                                }),
                                Obx(
                                      () => controller.isLoading.value
                                      ? const CircularProgressIndicator()
                                      ...
                                      child: ListView.builder(
                                        shrinkWrap: true,
                                        scrollDirection: Axis.horizontal,
                                        itemCount: controller.therapistsList.length,
                                        itemBuilder: (context, position) {
                                          //var item = controller.featuredCourses.value[position] as Course;
                                          return PsychiatristsItem(
                                              controller.therapistsList[position],
                                            null,
                                            null,
                                            ""
                                          );
                                ...
                                //////// trainers///////
                                getRowHeader(_local.trainers, () {
                                  Get.to(CoachShowAllScreen());
                                }),
                                Obx(
                                      () => controller.isLoading.value
                                      ? const CircularProgressIndicator()
                                      ...
                                      child: ListView.builder(
                                        shrinkWrap: true,
                                        scrollDirection: Axis.horizontal,
                                        itemCount: controller.coachsList.length,
                                        itemBuilder: (context, position) {
                                          //var item = controller.featuredCourses.value[position] as Course;
                                          return TrainersItem(
                                              controller.coachsList[position],
                                            null,
                                            ""
                                          );
                                        },
